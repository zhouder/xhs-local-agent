...
class Note(TimestampMixin, Base):
    ...
    publish_kind: Mapped[str] = mapped_column(String(40), default="image_text_to_image")
    text_to_image_prompt: Mapped[str] = mapped_column(Text, default="")
    text_to_image_style: Mapped[str] = mapped_column(Text, default="")
    video_file_path: Mapped[str] = mapped_column(String(1000), default="")
